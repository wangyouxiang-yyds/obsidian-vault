...
- [20260521_MS6_Pipeline執行紀錄.md](wiki/experiments/20260521_MS6_Pipeline執行紀錄.md) — Steps 2–5 實際執行結果：220 VRT 建立、fold split、patch 座標生成、YAML 更新、試跑 Fold 1 卡住問題與資料單位 Bug 診斷
